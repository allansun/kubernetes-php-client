...
class ConfigMap extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\ConfigMap $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheConfigMap|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ConfigMap $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
