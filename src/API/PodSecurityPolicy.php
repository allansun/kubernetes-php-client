...
class PodSecurityPolicy extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\PodSecurityPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodSecurityPolicy|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\PodSecurityPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function createPolicyV1beta1(\Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodSecurityPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/policy/v1beta1/podsecuritypolicies",
     ...
     * @return Status|mixed
     */
    public function deleteCollectionPolicyV1beta1(\Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/policy/v1beta1/podsecuritypolicies",
     ...
     * @return ThePodSecurityPolicyV1beta1|mixed
     */
    public function readPolicyV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return ThePodSecurityPolicyV1beta1|mixed
     */
    public function replacePolicyV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodSecurityPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/policy/v1beta1/podsecuritypolicies/{$name}",
     ...
     * @return Status|mixed
     */
    public function deletePolicyV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/policy/v1beta1/podsecuritypolicies/{$name}",
     ...
     * @return ThePodSecurityPolicyV1beta1|mixed
     */
    public function patchPolicyV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/policy/v1beta1/podsecuritypolicies/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListPolicyV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchPolicyV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
