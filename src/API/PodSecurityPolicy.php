...
class PodSecurityPolicy extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return ThePodSecurityPolicy|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\PodSecurityPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodSecurityPolicyV1beta1|mixed
     */
    public function replacePolicyV1beta1($name, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodSecurityPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/policy/v1beta1/podsecuritypolicies/{$name}"
     ...
     * @return ThePodSecurityPolicyV1beta1|mixed
     */
    public function patchPolicyV1beta1($name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/policy/v1beta1/podsecuritypolicies/{$name}"
