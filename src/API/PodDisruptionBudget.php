...
class PodDisruptionBudget extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodDisruptionBudget $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodDisruptionBudget $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodDisruptionBudget $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/policy/v1beta1/namespaces/{$namespace}/poddisruptionbudgets/{$name}/status",
