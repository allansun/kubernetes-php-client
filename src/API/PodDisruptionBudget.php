...
class PodDisruptionBudget extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Policy\V1\PodDisruptionBudget $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1\PodDisruptionBudget $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1\PodDisruptionBudget $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/policy/v1/namespaces/{$namespace}/poddisruptionbudgets/{$name}/status",
