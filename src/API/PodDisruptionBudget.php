...
class PodDisruptionBudget extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodDisruptionBudget $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodDisruptionBudget $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodDisruptionBudget|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Policy\V1beta1\PodDisruptionBudget $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/policy/v1beta1/namespaces/{$namespace}/poddisruptionbudgets/{$name}/status"
