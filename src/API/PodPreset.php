...
class PodPreset extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Settings\V1alpha1\PodPreset $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodPreset|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Settings\V1alpha1\PodPreset $Model, array $queries = [])
    {
        return $this->parseResponse(
