...
class RoleBinding extends AbstractAPI
{
     ...
     */
    public function createRbacAuthorizationV1(\Kubernetes\Model\Io\K8s\Api\Rbac\V1\RoleBinding $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheRoleBinding|mixed
     */
    public function replaceRbacAuthorizationV1(string $name, \Kubernetes\Model\Io\K8s\Api\Rbac\V1\RoleBinding $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
