...
class RoleBinding extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function createRbacAuthorizationV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Rbac\V1\RoleBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return Status|mixed
     */
    public function deleteRbacAuthorizationV1Collection($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheRoleBinding|mixed
     */
    public function replaceRbacAuthorizationV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Rbac\V1\RoleBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function createRbacAuthorizationV1alpha1($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Rbac\V1alpha1\RoleBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{$namespace}/rolebindings"
     ...
     * @return Status|mixed
     */
    public function deleteRbacAuthorizationV1alpha1Collection($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{$namespace}/rolebindings"
     ...
     * @return TheRoleBindingV1alpha1|mixed
     */
    public function replaceRbacAuthorizationV1alpha1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Rbac\V1alpha1\RoleBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{$namespace}/rolebindings/{$name}"
     ...
     */
    public function createRbacAuthorizationV1beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Rbac\V1beta1\RoleBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{$namespace}/rolebindings"
     ...
     * @return Status|mixed
     */
    public function deleteRbacAuthorizationV1beta1Collection($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{$namespace}/rolebindings"
     ...
     * @return TheRoleBindingV1beta1|mixed
     */
    public function replaceRbacAuthorizationV1beta1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Rbac\V1beta1\RoleBinding $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{$namespace}/rolebindings/{$name}"
