...
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\PodSchedulingList as PodSchedulingList;
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\PodScheduling as ThePodScheduling;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;

class PodScheduling extends AbstractAPI
{
    /**
     ...
     *
     * @return PodSchedulingList|mixed
     */
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return ThePodScheduling|mixed
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\PodScheduling $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @param string $namespace object name and auth scope, such as for teams and
     * projects
     * @param string $name name of the PodScheduling
     * @param array $queries options:
     * 'pretty'	string
     * If 'true', then the output is pretty printed.
     *
     ...
     * @return ThePodScheduling|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\PodScheduling $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodScheduling|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\PodScheduling $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/resource.k8s.io/v1alpha1/namespaces/{$namespace}/podschedulings/{$name}/status",
    ...
    /**
     * watch individual changes to a list of PodScheduling. deprecated: use the 'watch'
    ...
    /**
     * watch changes to an object of kind PodScheduling. deprecated: use the 'watch'
