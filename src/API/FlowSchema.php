...
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchemaList as FlowSchemaListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchema as TheFlowSchemaV1beta1;
...
class FlowSchema extends AbstractAPI
{
     ...
     * @return TheFlowSchema|mixed
     */
    public function replaceFlowcontrolApiserverV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1alpha1\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheFlowSchema|mixed
     */
    public function replaceFlowcontrolApiserverV1alpha1Status(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1alpha1\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{$name}/status",
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return FlowSchemaListV1beta1|mixed
     */
     ...
     * create a FlowSchema
     *
     * @param TheFlowSchemaV1beta1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return TheFlowSchemaV1beta1|mixed
     */
    public function createFlowcontrolApiserverV1beta1(\Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas",
     ...
     * @return TheFlowSchemaV1beta1|mixed
     */
    public function replaceFlowcontrolApiserverV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{$name}",
     ...
     * @return TheFlowSchemaV1beta1|mixed
     */
    public function replaceFlowcontrolApiserverV1beta1Status(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{$name}/status",
