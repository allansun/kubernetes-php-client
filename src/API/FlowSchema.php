...
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchemaList as FlowSchemaList;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\FlowSchema as TheFlowSchema;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\FlowSchemaList as FlowSchemaListV1beta2;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\FlowSchema as TheFlowSchemaV1beta2;
...
class FlowSchema extends AbstractAPI
{
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return FlowSchemaListV1beta2|mixed
     */
     ...
     * create a FlowSchema
     *
     * @param TheFlowSchemaV1beta2 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return TheFlowSchemaV1beta2|mixed
     */
    public function createFlowcontrolApiserverV1beta2(\Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas",
     ...
     * @return TheFlowSchemaV1beta2|mixed
     */
    public function replaceFlowcontrolApiserverV1beta2(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{$name}",
     ...
     * @return TheFlowSchemaV1beta2|mixed
     */
    public function replaceFlowcontrolApiserverV1beta2Status(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\FlowSchema $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{$name}/status",
