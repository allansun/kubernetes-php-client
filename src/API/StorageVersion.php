...
class StorageVersion extends AbstractAPI
{
     ...
     * @return TheStorageVersion|mixed
     */
    public function readInternalApiserverV1alpha1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return Status|mixed
     */
    public function deleteInternalApiserverV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{$name}",
     ...
     * @return TheStorageVersion|mixed
     */
    public function patchInternalApiserverV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStorageVersion|mixed
     */
    public function readInternalApiserverV1alpha1Status(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheStorageVersion|mixed
     */
    public function patchInternalApiserverV1alpha1Status(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{$name}/status",
     ...
     */
    public function watchInternalApiserverV1alpha1List(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchInternalApiserverV1alpha1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
