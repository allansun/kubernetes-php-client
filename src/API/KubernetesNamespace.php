...
class KubernetesNamespace extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return TheKubernetesNamespace|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Api\Core\V1\KubernetesNamespace $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheKubernetesNamespace|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Api\Core\V1\KubernetesNamespace $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$name}/status"
