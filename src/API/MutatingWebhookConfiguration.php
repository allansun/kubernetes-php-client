...
class MutatingWebhookConfiguration extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1beta1\MutatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheMutatingWebhookConfiguration|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1beta1\MutatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
