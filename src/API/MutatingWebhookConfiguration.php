...
class MutatingWebhookConfiguration extends AbstractAPI
{
     ...
     * @return TheMutatingWebhookConfiguration|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\MutatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheMutatingWebhookConfigurationV1beta1|mixed
     */
    public function replaceAdmissionregistrationV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1beta1\MutatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{$name}",
