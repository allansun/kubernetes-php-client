...
class ResourceQuota extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Core\V1\ResourceQuota $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheResourceQuota|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ResourceQuota $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheResourceQuota|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ResourceQuota $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/resourcequotas/{$name}/status"
