...
class HorizontalPodAutoscaler extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return Status|mixed
     */
    public function deleteCollectionAutoscalingV2beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/autoscaling/v2beta1/namespaces/{$namespace}/horizontalpodautoscalers"
     ...
     * @return Status|mixed
     */
    public function deleteCollectionAutoscalingV2beta2($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/autoscaling/v2beta2/namespaces/{$namespace}/horizontalpodautoscalers"
