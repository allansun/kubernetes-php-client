...
class HorizontalPodAutoscaler extends \Kubernetes\AbstractAPI
{
     ...
     */
    public function createAutoscalingV2beta2($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Autoscaling\V2beta2\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/autoscaling/v2beta2/namespaces/{$namespace}/horizontalpodautoscalers"
     ...
     * @return TheHorizontalPodAutoscalerV2beta2|mixed
     */
    public function replaceAutoscalingV2beta2($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Autoscaling\V2beta2\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/autoscaling/v2beta2/namespaces/{$namespace}/horizontalpodautoscalers/{$name}"
     ...
     * @return TheHorizontalPodAutoscalerV2beta2|mixed
     */
    public function patchAutoscalingV2beta2($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model)
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/autoscaling/v2beta2/namespaces/{$namespace}/horizontalpodautoscalers/{$name}"
     ...
     * @return TheHorizontalPodAutoscalerV2beta2|mixed
     */
    public function replaceStatusAutoscalingV2beta2($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Autoscaling\V2beta2\HorizontalPodAutoscaler $Model)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/autoscaling/v2beta2/namespaces/{$namespace}/horizontalpodautoscalers/{$name}/status"
     ...
     * @return TheHorizontalPodAutoscalerV2beta2|mixed
     */
    public function patchStatusAutoscalingV2beta2($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model)
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/autoscaling/v2beta2/namespaces/{$namespace}/horizontalpodautoscalers/{$name}/status"
