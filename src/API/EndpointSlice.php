...
use \Kubernetes\Model\Io\K8s\Api\Discovery\V1beta1\EndpointSliceList as EndpointSliceListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Discovery\V1beta1\EndpointSlice as TheEndpointSliceV1beta1;
...
class EndpointSlice extends AbstractAPI
{
     ...
     * update, and remove notifications. Specify resourceVersion.
     *
     * @return EndpointSliceListV1beta1|mixed
     */
    public function listForAllNamespacesDiscoveryV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return EndpointSliceListV1beta1|mixed
     */
    public function listDiscoveryV1beta1(string $namespace, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @param string $namespace object name and auth scope, such as for teams and
     * projects
     * @param TheEndpointSliceV1beta1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return TheEndpointSliceV1beta1|mixed
     */
    public function createDiscoveryV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Api\Discovery\V1beta1\EndpointSlice $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/discovery.k8s.io/v1beta1/namespaces/{$namespace}/endpointslices",
     ...
     * @return Status|mixed
     */
    public function deleteCollectionDiscoveryV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/discovery.k8s.io/v1beta1/namespaces/{$namespace}/endpointslices",
     ...
     * @return TheEndpointSliceV1beta1|mixed
     */
    public function readDiscoveryV1beta1(string $namespace, string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheEndpointSliceV1beta1|mixed
     */
    public function replaceDiscoveryV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Discovery\V1beta1\EndpointSlice $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/discovery.k8s.io/v1beta1/namespaces/{$namespace}/endpointslices/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteDiscoveryV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/discovery.k8s.io/v1beta1/namespaces/{$namespace}/endpointslices/{$name}",
     ...
     * @return TheEndpointSliceV1beta1|mixed
     */
    public function patchDiscoveryV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/discovery.k8s.io/v1beta1/namespaces/{$namespace}/endpointslices/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListForAllNamespacesDiscoveryV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchListDiscoveryV1beta1(string $namespace, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchDiscoveryV1beta1(string $namespace, string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
