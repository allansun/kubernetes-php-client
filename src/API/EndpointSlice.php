...
class EndpointSlice extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Discovery\V1alpha1\EndpointSlice $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheEndpointSlice|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Discovery\V1alpha1\EndpointSlice $Model, array $queries = [])
    {
        return $this->parseResponse(
