...
class AuditSink extends AbstractAPI
{
     ...
     *
     * @param string $name name of the AuditSink
     * @param array $queries options:
     * 'exact'	boolean
     ...
     * @return TheAuditSink|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Auditregistration\V1alpha1\AuditSink $Model, array $queries = [])
    {
        return $this->parseResponse(
