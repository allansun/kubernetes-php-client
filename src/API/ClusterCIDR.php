...
use \Kubernetes\Model\Io\K8s\Api\Networking\V1alpha1\ClusterCIDRList as ClusterCIDRList;
use \Kubernetes\Model\Io\K8s\Api\Networking\V1alpha1\ClusterCIDR as TheClusterCIDR;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;

class ClusterCIDR extends AbstractAPI
{
    /**
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return TheClusterCIDR|mixed
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Networking\V1alpha1\ClusterCIDR $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     *
     * @param string $name name of the ClusterCIDR
     * @param array $queries options:
     * 'pretty'	string
     * If 'true', then the output is pretty printed.
     *
     ...
     * @return TheClusterCIDR|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Networking\V1alpha1\ClusterCIDR $Model, array $queries = [])
    {
        return $this->parseResponse(
    ...
    /**
     * watch individual changes to a list of ClusterCIDR. deprecated: use the 'watch'
    ...
    /**
     * watch changes to an object of kind ClusterCIDR. deprecated: use the 'watch'
