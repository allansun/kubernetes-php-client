...
class StatefulSet extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStatefulSet|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStatefulSet|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1/namespaces/{$namespace}/statefulsets/{$name}/status",
     ...
     */
    public function createAppsV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/statefulsets",
     ...
     * @return TheStatefulSetV1beta1|mixed
     */
    public function replaceAppsV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/statefulsets/{$name}",
     ...
     * @return TheStatefulSetV1beta1|mixed
     */
    public function replaceStatusAppsV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/statefulsets/{$name}/status",
     ...
     */
    public function createAppsV1beta2(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/statefulsets",
     ...
     * @return TheStatefulSetV1beta2|mixed
     */
    public function replaceAppsV1beta2(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/statefulsets/{$name}",
     ...
     * @return TheStatefulSetV1beta2|mixed
     */
    public function replaceStatusAppsV1beta2(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\StatefulSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/statefulsets/{$name}/status",
