...
use \Kubernetes\Model\Io\K8s\Api\Storage\V1alpha1\CSIStorageCapacityList as CSIStorageCapacityList;
use \Kubernetes\Model\Io\K8s\Api\Storage\V1alpha1\CSIStorageCapacity as TheCSIStorageCapacity;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\CSIStorageCapacityList as CSIStorageCapacityListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\CSIStorageCapacity as TheCSIStorageCapacityV1beta1;
...
class CSIStorageCapacity extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Storage\V1alpha1\CSIStorageCapacity $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheCSIStorageCapacity|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Storage\V1alpha1\CSIStorageCapacity $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function listForAllNamespacesStorageV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @param string $namespace object name and auth scope, such as for teams and
     * projects
     * @param TheCSIStorageCapacityV1beta1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * @return WatchEvent|mixed
     */
    public function watchListForAllNamespacesStorageV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
