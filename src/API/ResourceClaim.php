...
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClaimList as ResourceClaimList;
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClaim as TheResourceClaim;
...
class ResourceClaim extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClaim $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheResourceClaim|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClaim $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheResourceClaim|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClaim $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/resource.k8s.io/v1alpha1/namespaces/{$namespace}/resourceclaims/{$name}/status",
