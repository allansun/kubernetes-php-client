...
class Lease extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return Status|mixed
     */
    public function deleteCollectionCoordinationV1beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/coordination.k8s.io/v1beta1/namespaces/{$namespace}/leases"
