...
class Lease extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Coordination\V1\Lease $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheLease|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Coordination\V1\Lease $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function listForAllNamespacesCoordinationV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return LeaseListV1beta1|mixed
     */
    public function listCoordinationV1beta1(string $namespace, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     */
    public function createCoordinationV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Api\Coordination\V1beta1\Lease $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/coordination.k8s.io/v1beta1/namespaces/{$namespace}/leases",
     ...
     * @return Status|mixed
     */
    public function deleteCollectionCoordinationV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/coordination.k8s.io/v1beta1/namespaces/{$namespace}/leases",
     ...
     * @return TheLeaseV1beta1|mixed
     */
    public function readCoordinationV1beta1(string $namespace, string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheLeaseV1beta1|mixed
     */
    public function replaceCoordinationV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Coordination\V1beta1\Lease $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/coordination.k8s.io/v1beta1/namespaces/{$namespace}/leases/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteCoordinationV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/coordination.k8s.io/v1beta1/namespaces/{$namespace}/leases/{$name}",
     ...
     * @return TheLeaseV1beta1|mixed
     */
    public function patchCoordinationV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/coordination.k8s.io/v1beta1/namespaces/{$namespace}/leases/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListForAllNamespacesCoordinationV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchListCoordinationV1beta1(string $namespace, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchCoordinationV1beta1(string $namespace, string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
