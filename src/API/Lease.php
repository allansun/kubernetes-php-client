...
class Lease extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Coordination\V1beta1\Lease $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheLease|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Coordination\V1beta1\Lease $Model, array $queries = [])
    {
        return $this->parseResponse(
