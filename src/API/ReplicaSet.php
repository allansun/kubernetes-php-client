...
class ReplicaSet extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheReplicaSet|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheReplicaSet|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1/namespaces/{$namespace}/replicasets/{$name}/status",
     ...
     */
    public function createAppsV1beta2(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/replicasets",
     ...
     * @return TheReplicaSetV1beta2|mixed
     */
    public function replaceAppsV1beta2(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/replicasets/{$name}",
     ...
     * @return TheReplicaSetV1beta2|mixed
     */
    public function replaceStatusAppsV1beta2(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/replicasets/{$name}/status",
     ...
     */
    public function createExtensionsV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/replicasets",
     ...
     * @return TheReplicaSetV1beta1|mixed
     */
    public function replaceExtensionsV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/replicasets/{$name}",
     ...
     * @return TheReplicaSetV1beta1|mixed
     */
    public function replaceStatusExtensionsV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\ReplicaSet $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/extensions/v1beta1/namespaces/{$namespace}/replicasets/{$name}/status",
