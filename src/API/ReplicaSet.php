...
class ReplicaSet extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Apps\V1\ReplicaSet $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheReplicaSet|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ReplicaSet $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheReplicaSet|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ReplicaSet $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1/namespaces/{$namespace}/replicasets/{$name}/status",
