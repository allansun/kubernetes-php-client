...
class Service extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Core\V1\Service $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheService|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Service $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheService|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Service $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/services/{$name}/status",
