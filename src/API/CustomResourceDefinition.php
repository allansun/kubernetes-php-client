...
class CustomResourceDefinition extends \Kubernetes\AbstractAPI
{
     ...
     * @return TheCustomResourceDefinition|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Apiextensions_apiserver\Pkg\Apis\Apiextensions\V1beta1\CustomResourceDefinition $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheCustomResourceDefinition|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Apiextensions_apiserver\Pkg\Apis\Apiextensions\V1beta1\CustomResourceDefinition $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{$name}/status"
