...
class CustomResourceDefinition extends AbstractAPI
{
     ...
     * @return TheCustomResourceDefinition|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Apiextensions_apiserver\Pkg\Apis\Apiextensions\V1\CustomResourceDefinition $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheCustomResourceDefinition|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Apiextensions_apiserver\Pkg\Apis\Apiextensions\V1\CustomResourceDefinition $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{$name}/status",
     ...
     * @return TheCustomResourceDefinitionV1beta1|mixed
     */
    public function readApiextensionsV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheCustomResourceDefinitionV1beta1|mixed
     */
    public function replaceApiextensionsV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apiextensions_apiserver\Pkg\Apis\Apiextensions\V1beta1\CustomResourceDefinition $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteApiextensionsV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{$name}",
     ...
     * @return TheCustomResourceDefinitionV1beta1|mixed
     */
    public function patchApiextensionsV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{$name}",
     ...
     * @return TheCustomResourceDefinitionV1beta1|mixed
     */
    public function readStatusApiextensionsV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheCustomResourceDefinitionV1beta1|mixed
     */
    public function replaceStatusApiextensionsV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apiextensions_apiserver\Pkg\Apis\Apiextensions\V1beta1\CustomResourceDefinition $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{$name}/status",
     ...
     * @return TheCustomResourceDefinitionV1beta1|mixed
     */
    public function patchStatusApiextensionsV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{$name}/status",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListApiextensionsV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchApiextensionsV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
