...
class PersistentVolume extends AbstractAPI
{
    /**
     ...
     * @return ThePersistentVolume|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\PersistentVolume $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePersistentVolume|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\PersistentVolume $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/persistentvolumes/{$name}/status",
