...
class CSINode extends AbstractAPI
{
     ...
     * @return TheCSINode|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Storage\V1\CSINode $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheCSINodeV1beta1|mixed
     */
    public function replaceStorageV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\CSINode $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/storage.k8s.io/v1beta1/csinodes/{$name}",
