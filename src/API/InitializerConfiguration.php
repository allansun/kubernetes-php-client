...
class InitializerConfiguration extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1alpha1\InitializerConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheInitializerConfiguration|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1alpha1\InitializerConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
