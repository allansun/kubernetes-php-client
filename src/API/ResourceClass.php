...
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClassList as ResourceClassList;
use \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClass as TheResourceClass;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;

class ResourceClass extends AbstractAPI
{
    /**
     ...
     *
     * @return ResourceClassList|mixed
     */
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return TheResourceClass|mixed
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClass $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     *
     * @param string $name name of the ResourceClass
     * @param array $queries options:
     * 'pretty'	string
     * If 'true', then the output is pretty printed.
     *
     ...
     * @return TheResourceClass|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Resource\V1alpha1\ResourceClass $Model, array $queries = [])
    {
        return $this->parseResponse(
    ...
    /**
     * watch individual changes to a list of ResourceClass. deprecated: use the 'watch'
    ...
    /**
     * watch changes to an object of kind ResourceClass. deprecated: use the 'watch'
