...
use \Kubernetes\Model\Io\K8s\Api\Authentication\V1alpha1\SelfSubjectReview as TheSelfSubjectReview;
...
class SelfSubjectReview extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Authentication\V1alpha1\SelfSubjectReview $Model, array $queries = [])
    {
