...
class ReplicationController extends AbstractAPI
{
    /**
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Core\V1\ReplicationController $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheReplicationController|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ReplicationController $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheReplicationController|mixed
     */
    public function replaceStatus(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ReplicationController $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/replicationcontrollers/{$name}/status",
