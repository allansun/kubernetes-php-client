...
class Pod extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return ThePod|mixed
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Core\V1\Pod $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePod|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Pod $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePod|mixed
     */
    public function replaceStatus($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Pod $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/api/v1/namespaces/{$namespace}/pods/{$name}/status"
