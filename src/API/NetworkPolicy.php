...
class NetworkPolicy extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\NetworkPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheNetworkPolicy|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Extensions\V1beta1\NetworkPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function createNetworkingV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Networking\V1\NetworkPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/networkpolicies"
     ...
     * @return TheNetworkPolicyV1|mixed
     */
    public function replaceNetworkingV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Networking\V1\NetworkPolicy $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/networkpolicies/{$name}"
