...
class StorageClass extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Storage\V1\StorageClass $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStorageClass|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Api\Storage\V1\StorageClass $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function createStorageV1beta1(\Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\StorageClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/storage.k8s.io/v1beta1/storageclasses"
     ...
     * @return TheStorageClassV1beta1|mixed
     */
    public function replaceStorageV1beta1($name, \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\StorageClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/storage.k8s.io/v1beta1/storageclasses/{$name}"
