...
class StorageClass extends AbstractAPI
{
     ...
     * @return TheStorageClass|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Storage\V1\StorageClass $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheStorageClassV1beta1|mixed
     */
    public function replaceStorageV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Storage\V1beta1\StorageClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/storage.k8s.io/v1beta1/storageclasses/{$name}",
