...
class VolumeAttachment extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Storage\V1alpha1\VolumeAttachment $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheVolumeAttachment|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Api\Storage\V1alpha1\VolumeAttachment $Model, array $queries = [])
    {
        return $this->parseResponse(
