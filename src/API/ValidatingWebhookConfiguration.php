...
class ValidatingWebhookConfiguration extends AbstractAPI
{
     ...
     * @return TheValidatingWebhookConfiguration|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1\ValidatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheValidatingWebhookConfigurationV1beta1|mixed
     */
    public function readAdmissionregistrationV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheValidatingWebhookConfigurationV1beta1|mixed
     */
    public function replaceAdmissionregistrationV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1beta1\ValidatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteAdmissionregistrationV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{$name}",
     ...
     * @return TheValidatingWebhookConfigurationV1beta1|mixed
     */
    public function patchAdmissionregistrationV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListAdmissionregistrationV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchAdmissionregistrationV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
