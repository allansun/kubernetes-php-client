...
class ValidatingWebhookConfiguration extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1beta1\ValidatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheValidatingWebhookConfiguration|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Admissionregistration\V1beta1\ValidatingWebhookConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
