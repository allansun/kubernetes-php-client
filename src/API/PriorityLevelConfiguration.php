...
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfigurationList as PriorityLevelConfigurationList;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfiguration as ThePriorityLevelConfiguration;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\PriorityLevelConfigurationList as PriorityLevelConfigurationListV1beta2;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta2\PriorityLevelConfiguration as ThePriorityLevelConfigurationV1beta2;
...
class PriorityLevelConfiguration extends AbstractAPI
{
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return PriorityLevelConfigurationListV1beta2|mixed
     */
     ...
     * create a PriorityLevelConfiguration
     *
     * @param ThePriorityLevelConfigurationV1beta2 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return ThePriorityLevelConfigurationV1beta2|mixed
     */
