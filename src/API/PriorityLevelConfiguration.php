...
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfigurationList as PriorityLevelConfigurationListV1beta1;
use \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfiguration as ThePriorityLevelConfigurationV1beta1;
...
class PriorityLevelConfiguration extends AbstractAPI
{
     ...
     * @return ThePriorityLevelConfiguration|mixed
     */
    public function readFlowcontrolApiserverV1alpha1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return ThePriorityLevelConfiguration|mixed
     */
    public function replaceFlowcontrolApiserverV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1alpha1\PriorityLevelConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return Status|mixed
     */
    public function deleteFlowcontrolApiserverV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{$name}",
     ...
     * @return ThePriorityLevelConfiguration|mixed
     */
    public function patchFlowcontrolApiserverV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePriorityLevelConfiguration|mixed
     */
    public function readFlowcontrolApiserverV1alpha1Status(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return ThePriorityLevelConfiguration|mixed
     */
    public function replaceFlowcontrolApiserverV1alpha1Status(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1alpha1\PriorityLevelConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{$name}/status",
     ...
     * @return ThePriorityLevelConfiguration|mixed
     */
    public function patchFlowcontrolApiserverV1alpha1Status(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{$name}/status",
     ...
     */
    public function watchFlowcontrolApiserverV1alpha1List(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchFlowcontrolApiserverV1alpha1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return PriorityLevelConfigurationListV1beta1|mixed
     */
    public function listFlowcontrolApiserverV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * create a PriorityLevelConfiguration
     *
     * @param ThePriorityLevelConfigurationV1beta1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function createFlowcontrolApiserverV1beta1(\Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations",
     ...
     * @return Status|mixed
     */
    public function deleteFlowcontrolApiserverV1beta1Collection(\Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations",
     ...
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function readFlowcontrolApiserverV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function replaceFlowcontrolApiserverV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteFlowcontrolApiserverV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{$name}",
     ...
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function patchFlowcontrolApiserverV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{$name}",
     ...
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function readFlowcontrolApiserverV1beta1Status(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function replaceFlowcontrolApiserverV1beta1Status(string $name, \Kubernetes\Model\Io\K8s\Api\Flowcontrol\V1beta1\PriorityLevelConfiguration $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{$name}/status",
     ...
     * @return ThePriorityLevelConfigurationV1beta1|mixed
     */
    public function patchFlowcontrolApiserverV1beta1Status(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{$name}/status",
     ...
     * @return WatchEvent|mixed
     */
    public function watchFlowcontrolApiserverV1beta1List(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchFlowcontrolApiserverV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
