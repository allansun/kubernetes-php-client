...
class APIService extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return TheAPIService|mixed
     */
    public function replace($name, \Kubernetes\Model\Io\K8s\Kube_aggregator\Pkg\Apis\Apiregistration\V1\APIService $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheAPIService|mixed
     */
    public function replaceStatus($name, \Kubernetes\Model\Io\K8s\Kube_aggregator\Pkg\Apis\Apiregistration\V1\APIService $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiregistration.k8s.io/v1/apiservices/{$name}/status"
     ...
     * @return Status|mixed
     */
    public function deleteCollectionApiregistrationV1beta1(\Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/apiregistration.k8s.io/v1beta1/apiservices"
     ...
     * @return TheAPIServiceV1beta1|mixed
     */
    public function replaceApiregistrationV1beta1($name, \Kubernetes\Model\Io\K8s\Kube_aggregator\Pkg\Apis\Apiregistration\V1beta1\APIService $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiregistration.k8s.io/v1beta1/apiservices/{$name}"
     ...
     * @return TheAPIServiceV1beta1|mixed
     */
    public function patchApiregistrationV1beta1($name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/apiregistration.k8s.io/v1beta1/apiservices/{$name}"
     ...
     * @return TheAPIServiceV1beta1|mixed
     */
    public function replaceStatusApiregistrationV1beta1($name, \Kubernetes\Model\Io\K8s\Kube_aggregator\Pkg\Apis\Apiregistration\V1beta1\APIService $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apiregistration.k8s.io/v1beta1/apiservices/{$name}/status"
     ...
     * @return TheAPIServiceV1beta1|mixed
     */
    public function patchStatusApiregistrationV1beta1($name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/apiregistration.k8s.io/v1beta1/apiservices/{$name}/status"
