...
class Event extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return EventListV1|mixed
     */
    public function listEventsV1($namespace = 'default', array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     */
    public function createEventsV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Events\V1\Event $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/events.k8s.io/v1/namespaces/{$namespace}/events"
     ...
     * @return Status|mixed
     */
    public function deleteCollectionEventsV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/events.k8s.io/v1/namespaces/{$namespace}/events"
     ...
     * @return TheEventV1|mixed
     */
    public function readEventsV1($namespace = 'default', $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheEventV1|mixed
     */
    public function replaceEventsV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Events\V1\Event $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/events.k8s.io/v1/namespaces/{$namespace}/events/{$name}"
     ...
     * @return Status|mixed
     */
    public function deleteEventsV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/events.k8s.io/v1/namespaces/{$namespace}/events/{$name}"
     ...
     * @return TheEventV1|mixed
     */
    public function patchEventsV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/events.k8s.io/v1/namespaces/{$namespace}/events/{$name}"
     ...
     * @return WatchEvent|mixed
     */
    public function watchListEventsV1($namespace = 'default')
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchEventsV1($namespace = 'default', $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return Status|mixed
     */
    public function deleteCollectionEventsV1beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/events.k8s.io/v1beta1/namespaces/{$namespace}/events"
