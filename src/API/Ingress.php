...
class Ingress extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function createNetworkingV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Networking\V1\Ingress $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses"
     ...
     * @return Status|mixed
     */
    public function deleteCollectionNetworkingV1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses"
     ...
     * @return TheIngressV1|mixed
     */
    public function replaceNetworkingV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Networking\V1\Ingress $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses/{$name}"
     ...
     * @return TheIngressV1|mixed
     */
    public function patchNetworkingV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses/{$name}"
     ...
     * @return TheIngressV1|mixed
     */
    public function readStatusNetworkingV1($namespace = 'default', $name)
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheIngressV1|mixed
     */
    public function replaceStatusNetworkingV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Networking\V1\Ingress $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses/{$name}/status"
     ...
     * @return TheIngressV1|mixed
     */
    public function patchStatusNetworkingV1($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses/{$name}/status"
     ...
     * @return Status|mixed
     */
    public function deleteCollectionNetworkingV1beta1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/networking.k8s.io/v1beta1/namespaces/{$namespace}/ingresses"
