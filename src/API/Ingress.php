...
class Ingress extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Networking\V1\Ingress $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheIngress|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Networking\V1\Ingress $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheIngress|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Networking\V1\Ingress $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/networking.k8s.io/v1/namespaces/{$namespace}/ingresses/{$name}/status",
