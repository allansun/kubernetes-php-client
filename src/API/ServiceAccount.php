...
class ServiceAccount extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\ServiceAccount $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheServiceAccount|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ServiceAccount $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
