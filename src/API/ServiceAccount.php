...
class ServiceAccount extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Core\V1\ServiceAccount $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheServiceAccount|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ServiceAccount $Model, array $queries = [])
    {
        return $this->parseResponse(
