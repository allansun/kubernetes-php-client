...
class ServiceAccount extends \KubernetesRuntime\AbstractAPI
{
     ...
     */
    public function create($namespace = 'default', \Kubernetes\Model\Io\K8s\Api\Core\V1\ServiceAccount $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheServiceAccount|mixed
     */
    public function replace($namespace = 'default', $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\ServiceAccount $Model, array $queries = [])
    {
        return $this->parseResponse(
