...
class ControllerRevision extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheControllerRevision|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     */
    public function createAppsV1beta1(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/controllerrevisions",
     ...
     * @return TheControllerRevisionV1beta1|mixed
     */
    public function replaceAppsV1beta1(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta1\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta1/namespaces/{$namespace}/controllerrevisions/{$name}",
     ...
     */
    public function createAppsV1beta2(string $namespace, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/controllerrevisions",
     ...
     * @return TheControllerRevisionV1beta2|mixed
     */
    public function replaceAppsV1beta2(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Apps\V1beta2\ControllerRevision $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/apps/v1beta2/namespaces/{$namespace}/controllerrevisions/{$name}",
