...
class CertificateSigningRequest extends AbstractAPI
{
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function readApproval(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replaceApproval(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1/certificatesigningrequests/{$name}/approval",
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function patchApproval(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/certificates.k8s.io/v1/certificatesigningrequests/{$name}/approval",
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1/certificatesigningrequests/{$name}/status",
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function readCertificatesV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function replaceCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}",
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function patchCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}",
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function readApprovalCertificatesV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function replaceApprovalCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}/approval",
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function patchApprovalCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}/approval",
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function readStatusCertificatesV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function replaceStatusCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}/status",
     ...
     * @return TheCertificateSigningRequestV1beta1|mixed
     */
    public function patchStatusCertificatesV1beta1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}/status",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListCertificatesV1beta1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchCertificatesV1beta1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
