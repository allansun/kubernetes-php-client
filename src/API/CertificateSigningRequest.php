...
class CertificateSigningRequest extends AbstractAPI
{
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replaceApproval(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
     ...
     * @return TheCertificateSigningRequest|mixed
     */
    public function replaceStatus(string $name, \Kubernetes\Model\Io\K8s\Api\Certificates\V1beta1\CertificateSigningRequest $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{$name}/status",
