...
use \Kubernetes\Model\Io\K8s\Api\Node\V1\RuntimeClassList as RuntimeClassList;
use \Kubernetes\Model\Io\K8s\Api\Node\V1\RuntimeClass as TheRuntimeClass;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions as DeleteOptions;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Status as Status;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch as Patch;
use \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\WatchEvent as WatchEvent;
use \Kubernetes\Model\Io\K8s\Api\Node\V1alpha1\RuntimeClassList as RuntimeClassListV1alpha1;
use \Kubernetes\Model\Io\K8s\Api\Node\V1alpha1\RuntimeClass as TheRuntimeClassV1alpha1;
...
class RuntimeClass extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Node\V1\RuntimeClass $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheRuntimeClass|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Node\V1\RuntimeClass $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return RuntimeClassListV1alpha1|mixed
     */
    public function listNodeV1alpha1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * create a RuntimeClass
     *
     * @param TheRuntimeClassV1alpha1 $Model
     * @param array $queries options:
     * 'dryRun'	string
     * When present, indicates that modifications should not be persisted. An invalid
     * or unrecognized dryRun directive will result in an error response and no further
     ...
     * If 'true', then the output is pretty printed.
     *
     * @return TheRuntimeClassV1alpha1|mixed
     */
    public function createNodeV1alpha1(\Kubernetes\Model\Io\K8s\Api\Node\V1alpha1\RuntimeClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('post',
        		"/apis/node.k8s.io/v1alpha1/runtimeclasses",
     ...
     * @return Status|mixed
     */
    public function deleteCollectionNodeV1alpha1(\Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/node.k8s.io/v1alpha1/runtimeclasses",
     ...
     * @return TheRuntimeClassV1alpha1|mixed
     */
    public function readNodeV1alpha1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return TheRuntimeClassV1alpha1|mixed
     */
    public function replaceNodeV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Api\Node\V1alpha1\RuntimeClass $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('put',
        		"/apis/node.k8s.io/v1alpha1/runtimeclasses/{$name}",
     ...
     * @return Status|mixed
     */
    public function deleteNodeV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/node.k8s.io/v1alpha1/runtimeclasses/{$name}",
     ...
     * @return TheRuntimeClassV1alpha1|mixed
     */
    public function patchNodeV1alpha1(string $name, \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\Patch $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('patch',
        		"/apis/node.k8s.io/v1alpha1/runtimeclasses/{$name}",
     ...
     * @return WatchEvent|mixed
     */
    public function watchListNodeV1alpha1(array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
     ...
     * @return WatchEvent|mixed
     */
    public function watchNodeV1alpha1(string $name, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('get',
