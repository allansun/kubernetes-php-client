...
class Endpoints extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\Endpoints $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return TheEndpoints|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Endpoints $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
