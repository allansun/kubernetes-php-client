...
class Endpoints extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Core\V1\Endpoints $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return TheEndpoints|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\Endpoints $Model, array $queries = [])
    {
        return $this->parseResponse(
