...
class CronJob extends \KubernetesRuntime\AbstractAPI
{
     ...
     * @return Status|mixed
     */
    public function deleteCollectionBatchV2alpha1($namespace = 'default', \Kubernetes\Model\Io\K8s\Apimachinery\Pkg\Apis\Meta\V1\DeleteOptions $Model, array $queries = [])
    {
        return $this->parseResponse(
        	$this->client->request('delete',
        		"/apis/batch/v2alpha1/namespaces/{$namespace}/cronjobs"
