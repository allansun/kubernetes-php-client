...
class PodTemplate extends AbstractAPI
{
     ...
     */
    public function create(string $namespace, \Kubernetes\Model\Io\K8s\Api\Core\V1\PodTemplate $Model, array $queries = [])
    {
        return $this->parseResponse(
     ...
     * @return ThePodTemplate|mixed
     */
    public function replace(string $namespace, string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\PodTemplate $Model, array $queries = [])
    {
        return $this->parseResponse(
