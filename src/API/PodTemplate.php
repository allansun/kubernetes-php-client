...
class PodTemplate extends AbstractAPI
{
     ...
     */
    public function create(\Kubernetes\Model\Io\K8s\Api\Core\V1\PodTemplate $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
     ...
     * @return ThePodTemplate|mixed
     */
    public function replace(string $name, \Kubernetes\Model\Io\K8s\Api\Core\V1\PodTemplate $Model, array $queries = [], string $namespace)
    {
        return $this->parseResponse(
