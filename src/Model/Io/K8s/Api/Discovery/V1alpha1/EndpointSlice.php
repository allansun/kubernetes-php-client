 ...
 */
class EndpointSlice extends \KubernetesRuntime\AbstractModel
{
     ...
     * currently supported: * IP:   Represents an IP Address. This can include both
     * IPv4 and IPv6
     *         addresses.
     ...
     * @var string
     */
    public $apiVersion = 'discovery.k8s.io/v1alpha1';
