 ...
 */
class Endpoint extends \KubernetesRuntime\AbstractModel
{

    /**
     * addresses of this endpoint. The contents of this field are interpreted according
     * to the corresponding EndpointSlice addressType field. This allows for cases like
     * dual-stack networking where both IPv4 and IPv6 addresses would be included with
     * the IP addressType. Consumers (e.g. kube-proxy) must handle different types of
     * addresses in the context of their own capabilities. This must contain at least
     * one address but no more than 100.
     *
     * @var string[]
     */
