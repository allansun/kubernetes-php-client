 ...
 */
class WindowsSecurityContextOptions extends \KubernetesRuntime\AbstractModel
{
     ...
     * value specified in SecurityContext takes precedence. This field is beta-level
     * and may be disabled with the WindowsRunAsUserName feature flag.
     *
     * @var string
     */
