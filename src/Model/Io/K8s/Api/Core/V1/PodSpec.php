...
class PodSpec extends \KubernetesRuntime\AbstractModel
{
     ...
     * Ephemeral containers are added to an existing pod as a result of a
     * user-initiated action such as troubleshooting. This list is read-only in the pod
     * spec. It may not be specified in a create or modified in an update of a pod or
     * pod template. To add an ephemeral container use the pod's ephemeralcontainers
     * subresource, which allows update using the EphemeralContainers kind. This field
     ...
     */
    public $topologySpreadConstraints = null;
