...
class Lifecycle extends \KubernetesRuntime\AbstractModel
{
     ...
     * contention, etc. The handler is not called if the container crashes or exits.
     * The reason for termination is passed to the handler. The Pod's termination grace
     ...
     * termination grace period. Other management of the container blocks until the
