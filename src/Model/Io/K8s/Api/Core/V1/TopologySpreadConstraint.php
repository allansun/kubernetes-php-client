...
class TopologySpreadConstraint extends AbstractModel
{
     ...
     * define an eligible domain as a domain whose nodes match the node selector. e.g.
     * If TopologyKey is "kubernetes.io/hostname", each Node is a domain of that
