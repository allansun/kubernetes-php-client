 ...
 * webhook
 */
class WebhookClientConfig extends \KubernetesRuntime\AbstractModel
{
     ...
     *
     * If there is only one port open for the service, that port will be used. If there
     * are multiple ports open, port 443 will be used if it is open, otherwise it is an
     * error.
     *
