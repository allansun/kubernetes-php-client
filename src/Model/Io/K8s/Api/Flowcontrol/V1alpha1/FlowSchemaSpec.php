 ...
 */
class FlowSchemaSpec extends \KubernetesRuntime\AbstractModel
{
     ...
     * value must be non-negative. Note that if the precedence is not specified or
     * zero, it will be set to 1000 as default.
     *
     * @var integer
     */
