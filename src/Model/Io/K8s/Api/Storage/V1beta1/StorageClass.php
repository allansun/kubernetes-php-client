 ...
 */
class StorageClass extends \KubernetesRuntime\AbstractModel
{
     ...
     * bound.  When unset, VolumeBindingImmediate is used. This field is alpha-level
     * and is only honored by servers that enable the VolumeScheduling feature.
     *
     * @var string
     */
