 ...
 * to.
 */
class PolicyRule extends \KubernetesRuntime\AbstractModel
{
     ...
     * are allowed, but only as the full, final step in the path This name is
     * intentionally different than the internal type so that the DefaultConvert works
     * nicely and because the ordering may be different. Since non-resource URLs are
