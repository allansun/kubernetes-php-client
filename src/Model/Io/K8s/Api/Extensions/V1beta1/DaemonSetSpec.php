 ...
 */
class DaemonSetSpec extends \KubernetesRuntime\AbstractModel
{
     ...
     * to be controlled. If empty, defaulted to labels on Pod template. More info:
     ...
     * @var integer
     */
    public $templateGeneration = null;
