...
class RollingUpdateDeployment extends \Kubernetes\AbstractModel
{
     ...
     * the rolling update starts, such that the total number of old and new pods do not
     * exceed 130% of desired pods. Once old pods have been killed, new RC can be
     * scaled up further, ensuring that total number of pods running at any time during
