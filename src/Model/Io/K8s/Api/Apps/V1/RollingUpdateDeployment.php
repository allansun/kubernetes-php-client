 ...
 */
class RollingUpdateDeployment extends \Kubernetes\AbstractModel
{
     ...
     * RC can be scaled down to 70% of desired pods immediately when the rolling update
     * starts. Once new pods are ready, old RC can be scaled down further, followed by
     * scaling up the new RC, ensuring that the total number of pods available at all
