...
class ListMeta extends \Kubernetes\AbstractModel
{
     ...
     * possible if the server configuration has changed or more than a few minutes have
     * passed. The resourceVersion field returned when using this continue value will
