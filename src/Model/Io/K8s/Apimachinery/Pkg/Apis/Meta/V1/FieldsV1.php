 ...
 * in a list 'k:<keys>', where <keys> is a map of  a list item's key fields to
 * their unique values If a key maps to an empty Fields value, the field that key
 * represents is part of the set.
 *
 * The exact format is defined in sigs.k8s.io/structured-merge-diff
 */
class FieldsV1 extends \KubernetesRuntime\AbstractModel
{
