...
class HorizontalPodAutoscaler extends AbstractModel
{
    ...
    /**
     * @param HorizontalPodAutoscalerSpec $spec
     *
     * @return self
     */
    public function setSpec($spec)
    {
        $this->spec = $this->_createPropertyValue($spec, HorizontalPodAutoscalerSpec::class, false);

        return $this;
    }

    /**
     * @param HorizontalPodAutoscalerStatus $status
     *
     * @return self
     */
    public function setStatus($status)
    {
        $this->status = $this->_createPropertyValue($status, HorizontalPodAutoscalerStatus::class, false);
