...
class ReplicationControllerSpec extends AbstractModel
{
    /**
     * @var integer
    ...
    /**
     * @var PodTemplateSpec
     * Template is the object that describes the pod that will be created if insufficient replicas are detected. This
     * takes precedence over a TemplateRef. More info:
