...
class PodDisruptionBudget extends AbstractModel
{
    /**
     * @var string
    ...
    /**
     * @param PodDisruptionBudgetSpec $spec
     *
     * @return self
     */
    public function setSpec($spec)
    {
        $this->spec = $this->_createPropertyValue($spec, PodDisruptionBudgetSpec::class, false);

        return $this;
    }

    /**
     * @param PodDisruptionBudgetStatus $status
     *
     * @return self
     */
    public function setStatus($status)
    {
        $this->status = $this->_createPropertyValue($status, PodDisruptionBudgetStatus::class, false);
