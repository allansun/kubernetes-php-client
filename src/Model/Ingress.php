...
class Ingress extends AbstractModel
{
     ...
     */
    public $apiVersion = 'extensions/' . Version::V1BETA1;
    ...
    /**
     * @param IngressSpec $spec
     *
     * @return self
     */
    public function setSpec($spec)
    {
        $this->spec = $this->_createPropertyValue($spec, IngressSpec::class, false);
    ...
    {
        $this->status = $this->_createPropertyValue($status, IngressStatus::class, false);
