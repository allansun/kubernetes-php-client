...
class PodPreset extends AbstractModel
{
    /**
     * @var string
     ...
     */
    public $apiVersion = Version::V1ALPHA1;
    ...
    /**
     * @param PodPresetSpec $spec
     *
     * @return self
     */
    public function setSpec($spec)
    {
        $this->spec = $this->_createPropertyValue($spec, PodPresetSpec::class, false);
